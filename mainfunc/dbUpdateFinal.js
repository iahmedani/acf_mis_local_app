...
module.exports = (knex) => {
    ...
    fs.stat(`${process.env.APPDATA}/nims_aapupdateHist.txt`, (err, stat) => {
        if (err) {
            knex.raw(`PRAGMA [main].legacy_alter_table = 'on'`)
                ...
                FROM [main].[_sqliteexpert_temp_table_1];`)
                    ...
                    fs.writeFile(`${process.env.APPDATA}/nims_aapupdateHist.txt`, '1', (err) => {
                        if (err) throw err;
            ...
            var updateCheck = fs.readFileSync(`${process.env.APPDATA}/nims_aapupdateHist.txt`)
            ...
            if (updateCheck == '1') {
                knex.raw(`SAVEPOINT [sqlite_expert_apply_design_transaction];`)
                    .then(r => {
                        ...
                        fs.writeFile(`${process.env.APPDATA}/nims_aapupdateHist.txt`, '2', (err) => {
                            if (err) throw err;
                ...
                knex.raw(`PRAGMA [main].legacy_alter_table = 'on';`)
                    .then(r => {
                        ...
                        fs.writeFile(`${process.env.APPDATA}/nims_aapupdateHist.txt`, '3', (err) => {
                            if (err) throw err;
...
WHERE  [tblsessions].[is_deleted] = 0`)
                    ...
                    .then(r => {
                        fs.writeFile(`${process.env.APPDATA}/nims_aapupdateHist.txt`, '4', (err) => {
                            if (err) throw err;
                ...
                WHERE  [main].[tblOtpAdd].[is_deleted] = 0;`)
                    ...
                    .then(r => {
                        fs.writeFile(`${process.env.APPDATA}/nims_aapupdateHist.txt`, '5', (err) => {
                            if (err) throw err;
                ...
                knex.raw(`PRAGMA [main].legacy_alter_table = 'on';`)
                    ...
                    .then(r => {
                        fs.writeFile(`${process.env.APPDATA}/nims_aapupdateHist.txt`, '6', (err) => {
                            if (err) throw err;
                ...
                knex.raw(`SAVEPOINT [sqlite_expert_apply_design_transaction];`)
                    ...
                    `)
                        ...
                        fs.writeFile(`${process.env.APPDATA}/nims_aapupdateHist.txt`, '7', (err) => {
                            if (err) throw err;
                ...
                knex.raw(`SAVEPOINT [sqlite_expert_apply_design_transaction];`)
                    ...
                    .then(r => {
                        fs.writeFile(`${process.env.APPDATA}/nims_aapupdateHist.txt`, '8', (err) => {
                            if (err) throw err;
             ...
             FROM   [main].[v_geo]
                    INNER JOIN [main].[v_otp_remaining] ON [main].[v_geo].[site_id] = [main].[v_otp_remaining].[site_id];`)
                        ...
                        fs.writeFile(`${process.env.APPDATA}/nims_aapupdateHist.txt`, '9', (err) => {
                            if (err) throw err;
                ...
                knex.raw(`SAVEPOINT [sqlite_expert_apply_design_transaction];`)
                    .then(r => {
                        ...
                        fs.writeFile(`${process.env.APPDATA}/nims_aapupdateHist.txt`, '10', (err) => {
                            if (err) throw err;
                ...
                knex.raw(`SAVEPOINT [sqlite_expert_apply_design_transaction];`)
                    .then(r => {
                        ...
                        fs.writeFile(`${process.env.APPDATA}/nims_aapupdateHist.txt`, '11', (err) => {
                            if (err) throw err;
                ...
                knex.raw(`SAVEPOINT [sqlite_expert_apply_design_transaction];`)
                    .then(r => {
                        ...
                        fs.writeFile(`${process.env.APPDATA}/nims_aapupdateHist.txt`, '12', (err) => {
                            if (err) throw err;
                            console.log('created new view for sessions to correct report and entry')
                        })
                    })
                ...
                knex.raw(`SAVEPOINT [sqlite_expert_apply_design_transaction];`)
                    .then(r => {
                        ...
                        fs.writeFile(`${process.env.APPDATA}/nims_aapupdateHist.txt`, '13', (err) => {
                            if (err) throw err;
