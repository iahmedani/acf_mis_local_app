...
//     fs.stat(`${process.env.APPDATA}/nims_aap/updateHist.txt`, (err, stat) => {
//         if (err) {
...
//                     }]
//                     fs.writeFile(`${process.env.APPDATA}/nims_aap/updateHist.txt`, '1', (err) => {
//                         if (err) throw err;
...
//                 })
//         } else if (stat) {
//             var updateCheck = fs.readFileSync(`${process.env.APPDATA}/nims_aap/updateHist.txt`)
...
//                         return knex.raw(`RELEASE [sqlite_expert_apply_design_transaction];`)
//                     }).then(r => {
//                         fs.writeFile(`${process.env.APPDATA}/nims_aap/updateHist.txt`, '2', (err) => {
//                             if (err) throw err;
...
//                         return knex.raw(`PRAGMA [main].legacy_alter_table = 'off';`)
//                     }).then(r => {
//                         fs.writeFile(`${process.env.APPDATA}/nims_aap/updateHist.txt`, '3', (err) => {
//                             if (err) throw err;
...
//                     })
//                     .then(r => {
//                         fs.writeFile(`${process.env.APPDATA}/nims_aap/updateHist.txt`, '4', (err) => {
//                             if (err) throw err;
...
//                     })
//                     .then(r => {
//                         fs.writeFile(`${process.env.APPDATA}/nims_aap/updateHist.txt`, '5', (err) => {
//                             if (err) throw err;
...
//                     })
//                     .then(r => {
//                         fs.writeFile(`${process.env.APPDATA}/nims_aap/updateHist.txt`, '6', (err) => {
//                             if (err) throw err;
...
//                         return knex.raw(`RELEASE [sqlite_expert_apply_design_transaction];`)
//                     }).then(r => {
//                         fs.writeFile(`${process.env.APPDATA}/nims_aap/updateHist.txt`, '7', (err) => {
//                             if (err) throw err;
...
//                     })
//                     .then(r => {
//                         fs.writeFile(`${process.env.APPDATA}/nims_aap/updateHist.txt`, '8', (err) => {
//                             if (err) throw err;
...
//                         return knex.raw(`RELEASE [sqlite_expert_apply_design_transaction];`)
//                     }).then(r => {
//                         fs.writeFile(`${process.env.APPDATA}/nims_aap/updateHist.txt`, '9', (err) => {
//                             if (err) throw err;
...
//                         return knex.raw(`RELEASE [sqlite_expert_apply_design_transaction];`)
//                     }).then(r => {
//                         fs.writeFile(`${process.env.APPDATA}/nims_aap/updateHist.txt`, '10', (err) => {
//                             if (err) throw err;
...
//                         return knex.raw(`RELEASE [sqlite_expert_apply_design_transaction];`)
//                     }).then(r => {
//                         fs.writeFile(`${process.env.APPDATA}/nims_aap/updateHist.txt`, '11', (err) => {
//                             if (err) throw err;
...
//                         return knex.raw(`RELEASE [sqlite_expert_apply_design_transaction];`)
//                     }).then(r => {
//                         fs.writeFile(`${process.env.APPDATA}/nims_aap/updateHist.txt`, '12', (err) => {
//                             if (err) throw err;
//                             console.log('created new view for sessions to correct report and entry')
//                         })
//                     })
...
//                         return knex.raw(`RELEASE [sqlite_expert_apply_design_transaction];`)
//                     }).then(r => {
//                         fs.writeFile(`${process.env.APPDATA}/nims_aap/updateHist.txt`, '13', (err) => {
//                             if (err) throw err;
