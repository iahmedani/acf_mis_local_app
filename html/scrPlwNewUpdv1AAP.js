module.exports.initScrPlwNewUpd = function () {
  ...
  function totalCheck() {
    ...
    ll2.each(function () {
      ll2Val += ($(this).val()) ? parseInt($(this).val()) : 0;
    })
    if (ltotal != l1Val) {
    ...
    if (l2total != ll2Val) {
      ll2.addClass('highlightInput')
    } else {
      ll2.removeClass('highlightInput')
    }
    if (ptotal != p1Val) {
